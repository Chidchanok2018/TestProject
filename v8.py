...
def interintra21(Start, Compare, DD):  # list[[],[],[]]
    ...
    Result = copy.deepcopy(Start)  # เตรียมไว้เป็นผลลัพท์ตอนเอาออกไป
    Result1 = Start  # ใส่ค่าเก่าลงไปในก้อนก่อน ค่าเปลี่ยนแปลงได้
    ...
    for h in range(count - 1):
        ...
        Start_L = Change_Shlist_TO_Llist(Start)  # List[....]
        G.add_cycle(Start_L)  # ต้อง Add แบบนี้เท่านั้นรูปจึงไม่เพี้ยน
        G.add_cycle(Next)  # ต้อง Add แบบนี้เท่านั้นรูปจึงไม่เพี้ยน
...
N_C21_I = interintra21(N3_C2_I, N_C21, 0.80)
